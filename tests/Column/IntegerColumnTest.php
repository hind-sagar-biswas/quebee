...
final class IntegerColumnTest extends TestCase
{
    ...
    public function test_big_integer_column_build()
    {
        ...
        $query = Col::integer(20)->zerofill()->build('column');
        $this->assertSame($expected, $query);
        ...
        $query = Col::integer(20)->unsigned()->zerofill()->build('column');
        $this->assertSame($expected, $query);
        $expected = "`column` BIGINT(20) ZEROFILL UNSIGNED NOT NULL";
        $query = Col::integer(20)->zerofill()->unsigned()->build('column');
        $this->assertSame($expected, $query);
    }
    ...
    public function test_medium_integer_column_build()
    {
        ...
        $query = Col::integer(15)->zerofill()->build('column');
        $this->assertSame($expected, $query);
        ...
        $query = Col::integer(15)->unsigned()->zerofill()->build('column');
        $this->assertSame($expected, $query);
        $expected = "`column` MEDIUMINT(15) ZEROFILL UNSIGNED NOT NULL";
        $query = Col::integer(15)->zerofill()->unsigned()->build('column');
        $this->assertSame($expected, $query);
    }
    ...
    public function test_small_integer_column_build()
    {
        ...
        $query = Col::integer(6)->zerofill()->build('column');
        $this->assertSame($expected, $query);
        ...
        $query = Col::integer(6)->unsigned()->zerofill()->build('column');
        $this->assertSame($expected, $query);
        $expected = "`column` SMALLINT(6) ZEROFILL UNSIGNED NOT NULL";
        $query = Col::integer(6)->zerofill()->unsigned()->build('column');
        $this->assertSame($expected, $query);
    }
    ...
    public function test_tiny_integer_column_build()
    {
        ...
        $query = Col::integer(2)->zerofill()->build('column');
        $this->assertSame($expected, $query);
        ...
        $query = Col::integer(2)->unsigned()->zerofill()->build('column');
        $this->assertSame($expected, $query);
        $expected = "`column` TINYINT(2) ZEROFILL UNSIGNED NOT NULL";
        $query = Col::integer(2)->zerofill()->unsigned()->build('column');
        $this->assertSame($expected, $query);
    }
}